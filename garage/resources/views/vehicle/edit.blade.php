...
select.form-control.select_vehicalbrand, select.form-control.model_addname, select.form-control.select_fueltype{
             ...
             <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 input-group-date date ">
                  @if ($vehicaledit->dom)
                  <input type="text" name="dom" autocomplete="off" placeholder="<?php echo getDateFormat(); ?>" value="{{ date(getDateFormat(), strtotime($vehicaledit->dom)) }}" class="form-control datepicker" />
                  @else
                  <input type="text" id="datepicker " autocomplete="off" class="form-control datepicker" placeholder="<?php echo getDateFormat(); ?>" value="" name="dom" />
                  @endif
                </div>
              </div>
            </div>
            ...
            <div class="row row-mb-0">
              ...
              <!-- <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 mt-0">
                ...
                <div class="form-group col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <input type="file" name="image[]" class="form-control imageclass" data-max-file-size="5M" id="images" multiple>
            ...
            <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 error_customfield_main_div_{{ $myCounts }}">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  ...
                  <input type="{{ $tbl_custom_field->type }}" name="custom[{{ $tbl_custom_field->id }}]" placeholder="{{ trans('message.Enter') }} {{ $tbl_custom_field->label }}" value="{{ $datavalue }}" maxlength="30" class="form-control textDate_{{ $tbl_custom_field->id }} date_simple_class common_value_is_{{ $myCounts }} common_simple_class" isRequire="{{ $required }}" fieldNameIs="{{ $tbl_custom_field->label }}" rows_id="{{ $myCounts }}" {{ $required }}>
...
<script nonce="{{ $cspNonce }}">
    ...
    $(document).ready(function() {
        ...
        // Also apply to dynamically added date fields
...
{!! preg_replace('/<script\b(?![^>]*\bnonce=)[^>]*>/i', '<script nonce="'.e($cspNonce).'">', (string) JsValidator::formRequest('App\Http\Requests\VehicleAddEditFormRequest', '#vehicleEdit-Form'), 1) !!}
