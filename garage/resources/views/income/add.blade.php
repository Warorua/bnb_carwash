            ...
            <div class="row form-group row-mb-0">
              <div class="row col-md-6 col-sm-6 col-xs-12 form-group my-form-group row-mb-0">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12  date">
                  <input type="text" id="income_date" name="date" autocomplete="off" class="form-control incomeDate datepicker" value="{{ old('date', date('Y-m-d')) }}" placeholder="<?php echo getDatepicker(); ?>" required autocomplete="off" />
                </div>
              </div>
...
{!! preg_replace('/<script\b(?![^>]*\bnonce=)[^>]*>/i', '<script nonce="'.e($cspNonce).'">', (string) JsValidator::formRequest('App\Http\Requests\StoreIncomeRequest', '#addIncomeForm'), 1) !!}
