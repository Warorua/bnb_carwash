          ...
          <form id="incomeMonthReportForm" method="post" action="{{ url('/income/income_report') }}" enctype="multipart/form-data" class="form-horizontal upperform addMonthIncomeSubmitButton">
            ...
            <div class="row {{ $errors->has('start_date') ? ' has-error' : '' }}">
              ...
              <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 date ">
                <input type="text" id="start_date" name="start_date" autocomplete="off" class="form-control expStartDate start_date" value="{{ !empty($s_date) ? date(getDateFormat(), strtotime($s_date)) : date(getDateFormat(), strtotime('first day of this month')) }}" placeholder="<?php echo getDatepicker(); ?>" required />
              </div>
            ...
            <div class="row mt-3 {{ $errors->has('end_date') ? ' has-error' : '' }}">
              ...
              <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 date ">
                <input type="text" id="end_date" name="end_date" autocomplete="off" class="form-control expenseEndDate end_date" value="{{ old('p_date', date('Y-m-d')) }}" placeholder="<?php echo getDatepicker(); ?>" required />
              </div>
              <div class="col-md-3 col-lg-3 col-xl-3 col-xxl-3 col-sm-3 col-xs-3"></div>
...
<!-- {!! JsValidator::formRequest('App\Http\Requests\StoreExpenseMonthlyReportFormRequest', '#incomeMonthReportForm') !!} -->
 {!! preg_replace('/<script\b(?![^>]*\bnonce=)[^>]*>/i', '<script nonce="'.e($cspNonce).'">', (string) JsValidator::formRequest('App\Http\Requests\StoreExpenseMonthlyReportFormRequest', '#incomeMonthReportForm'), 1) !!}
