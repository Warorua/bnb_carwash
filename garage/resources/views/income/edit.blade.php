                    ...
                    <form id="editIncomeForm" method="post" action="{{ URL::to('income/update/' . $first_data->id) }}" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group row-mb-0">
                            ...
                            <div class="row col-md-6 col-sm-6 col-xs-12 form-group outstandingMainDiv">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12 setProperText" for="invoice">
                                    {{ trans('message.Outstanding Amount') }} (<?php echo getCurrencySymbols(); ?>)
                                </label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <!-- Display field (disabled, for visual only) -->
                                    <input type="text" 
                                        class="form-control ttl_amount" 
                                        value="{{ number_format($outstanding_amount, 2) }}" 
                                        readonly 
                                        disabled 
                                        placeholder="{{ trans('message.Total Amount of Invoice') }}">
                        ...
                        <div class="row form-group row-mb-0">
                            <div class="row col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12 input-prepend date ">
                                    <input type="text" id="income_date" name="date" autocomplete="off" class="form-control incomeDate" placeholder="<?php echo getDateFormat(); ?>" value="{{ date(getDateFormat(), strtotime($first_data->date)) }}" required />
                                </div>
                            </div>
...
{!! preg_replace('/<script\b(?![^>]*\bnonce=)[^>]*>/i', '<script nonce="'.e($cspNonce).'">', (string) JsValidator::formRequest('App\Http\Requests\StoreIncomeRequest', '#editIncomeForm'), 1) !!}
