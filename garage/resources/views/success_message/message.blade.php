...
<div class="row massage">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="checkbox checkbox-success checkbox-circle mb-2 alert alert-success alert-dismissible fade show">
      ...
      @elseif(session('message') == 'License Registered Successfully.')
      <label for="checkbox-10 colo_success" style="margin-left: 20px;font-weight: 600;"> {{ trans('message.License Registered Successfully.') }}</label>
