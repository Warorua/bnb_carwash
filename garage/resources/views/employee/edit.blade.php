          ...
          <form id="employee_edit_form" method="post" action="update/{{ $user->id }}" enctype="multipart/form-data" class="form-horizontal upperform">
            ...
            <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6  {{ $errors->has('dob') ? ' has-error' : '' }}">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date">
                  @if ($user->birth_date)
                  <input type="text" id="date_of_birth" autocomplete="off" class="form-control datepicker1" placeholder="<?php echo getDateFormat(); ?>" name="dob" value="{{ date(getDateFormat(), strtotime($user->birth_date)) }}">
                  @else
                  <input type="text" id="date_of_birth" autocomplete="off" class="form-control datepicker1" placeholder="<?php echo getDateFormat(); ?>" value="" name="dob"/>
                  @endif
                </div>
              </div>
            </div>
