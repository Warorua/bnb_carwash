...
<!-- {!! JsValidator::formRequest('App\Http\Requests\StoreOtherSettingEditFormRequest', '#other_setting_edit_form') !!} -->
 {!! preg_replace('/<script\b(?![^>]*\bnonce=)[^>]*>/i', '<script nonce="'.e($cspNonce).'">', (string) JsValidator::formRequest('App\Http\Requests\StoreOtherSettingEditFormRequest', '#other_setting_edit_form'), 1) !!}
