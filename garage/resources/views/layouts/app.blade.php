...
<body id="app-layout" class="nav-md <?php echo getValue(); ?>">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <ul class="nav side-menu">
                ...
                @php
                $inventoryRoutes = ['/vehicle/list','/vehicletype/list','/vehiclebrand/list','/vehicalmodel/list','/color/list','/vehicle/add','/vehicletype/vehicletypeadd','/vehiclebrand/add','/color/add'];
                @endphp
                <li class="{{ in_array($currentRoute, $inventoryRoutes) || Str::startsWith($currentRoute, '/vehicle/list') || Str::startsWith($currentRoute, '/vehicletype/list/') || Str::startsWith($currentRoute, '/vehicalmodel/list/') || Str::startsWith($currentRoute, '/vehiclebrand/list/') || Str::startsWith($currentRoute, '/color/list/edit/') ? 'active' : '' }}">
                ...
                @endcan
                @php
                $inventoryRoutes = ['/mail/mail'];
                @endphp
                @can('emailtemplate_view')
                <li class="w-100 {{in_array($currentRoute,$inventoryRoutes)  || Str::startsWith($currentRoute, '/mail/mail')? 'active' : ''}}"><a href="{!! url('/mail/mail') !!}"><i class="fa-solid fa-envelope-open-text margin-right-10px"></i>{{ trans('message.Email Templates') }}</a></li>
                @endcan
  ...
  <!-- Bootstrap -->
  <script nonce="{{ $cspNonce }}"src="{{ URL::asset('build/js/popper.min.js') }}"></script>
  ...
  <!-- NProgress -->
  <script nonce="{{ $cspNonce }}"src="{{ URL::asset('vendors/nprogress/nprogress.js') }}"></script>

  <!-- DateJS for theme default js-->
  <script nonce="{{ $cspNonce }}"src="{{ URL::asset('vendors/DateJS/build/date.js') }}"></script>

  <!-- Custom Theme Scripts -->
  <!-- <script nonce="{{ $cspNonce }}"src="{{ URL::asset('build/js/custom.min.js') }}"></script> -->
  ...
  <!-- Filter  -->
  <script nonce="{{ $cspNonce }}"src="{{ URL::asset('vendors/jszip/dist/jszip.min.js') }}" ></script>

  <!-- Autocomplete Js  -->
  <script nonce="{{ $cspNonce }}"src="{{ URL::asset('build/js/jquery.circliful.min.js') }}"></script>

  <!-- Multiselect Js  -->
  <script nonce="{{ $cspNonce }}"src="{{ URL::asset('build/js/bootstrap-multiselect.js') }}" ></script>
  <script nonce="{{ $cspNonce }}"src="{{ URL::asset('vendors/select2/js/select2.min.js') }}" type='text/javascript'></script>
