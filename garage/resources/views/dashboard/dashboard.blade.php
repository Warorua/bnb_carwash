...
<div class="right_col position-relative " role="main" id="dashboard">
                        ...
                        <div class="row mt-2 row-mb-0">
                            ...
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 display-content">
                                ...
                                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 width-100 date">
                                  <input type='text' class="form-control datepicker" name="s_date" autocomplete="off" id='s_date' placeholder="<?php echo getDatepicker(); echo ' hh:mm:ss'; ?>" value="" required/>
                                </div>
                            </div>
    ...
    <script nonce="{{ $cspNonce }}">
     ...
     window.onload = function () {
            const sampleDataBtn = document.getElementById('add-sample-data-btn');
        ...
        const addSampleBtn = document.getElementById('add-sample-data-btn');
        if (addSampleBtn) {
        ...
        $(document).ready(function() {
            $('#s_date').on('keypress keydown keyup', function(e) {
                e.preventDefault();
                return false;
            });
        });
    ...
    <script nonce="{{ $cspNonce }}">
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                // toolkip: true,
                events: <?php 
                    if (!empty($data1) && $data1 !== '"0"' && $data1 !== '0') {
                        echo $data1;
                    } else {
                        echo '[]';
                    }
                ?>,
                    ...
                    // Use Bootstrap 5 Tooltip
                    var tooltipContent = title1 + title2 + title3 + title4 + title5;
    ...
    <script nonce="{{ $cspNonce }}">
        var freeServicesElement = document.getElementById('freeServices');
        var paidServicesElement = document.getElementById('paidServices');
        if (freeServicesElement && paidServicesElement) {
