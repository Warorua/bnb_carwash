                                ...
                                <div class="row row-mb-0">
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date ">
                                        <input type="text" id="date_of_birth" autocomplete="off" name="out_date" class="form-control datepicker" placeholder="<?php echo getDatepicker();
                                                                                                                         echo ' hh:mm:ss'; ?>"  value="{{ isset($jobcard_detail->out_date) ? $jobcard_detail->out_date : now()->setTimezone($timezone)->format('Y-m-d H:i:s') }}" required />
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- {!! JsValidator::formRequest('App\Http\Requests\StoreServiceSecondStepAddFormRequest', '#service2Step') !!} -->
 {!! preg_replace('/<script\b(?![^>]*\bnonce=)[^>]*>/i', '<script nonce="'.e($cspNonce).'">', (string) JsValidator::formRequest('App\Http\Requests\StoreServiceSecondStepAddFormRequest', '#service2Step'), 1) !!}
