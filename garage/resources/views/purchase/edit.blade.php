            ...
            <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 date">
                  <input type="text" id="pur_date" name="p_date" autocomplete="off" value="{{ date(getDateFormat(), strtotime($purchase->date)) }}" class="form-control datepicker purchaseDate" placeholder="<?php echo getDateFormat(); ?>" required />
                </div>
              </div>
            </div>
