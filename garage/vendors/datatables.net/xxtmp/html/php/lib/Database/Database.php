...
class Database
{
     ...
     * @param  array  $where  Where condition for what to select - see {@link *   Query::where}.
     ...
     *
     * @param  string|string[]  $table  Table name(s) to act upon.
     * @param  array  $where  Where condition for what to delete - see {@link *    Query::where}.
     * @return Result
     */
     ...
     *
     * @param  string|string[]  $table  Table name(s) to act upon.
     * @param  array  $set  Field names and values to set - see {@link *    Query::set}.
     ...
     * @param  string|string[]  $table  Table name(s) to act upon.
     * @param  array  $set  Field names and values to set - see {@link *    Query::set}.
     * @param  array  $where  Where condition for what to update - see {@link *    Query::where}.
     * @param  array  $pkey  Primary key column names (this is an array for
     *                       forwards compt, although only the first item in the array is actually
     *                       used). This doesn't need to be set, but it must be if you want to use
     ...
     *
     * @param  string|string[]  $table  Table name(s) to act upon.
     * @param  array  $field  Fields to get from the table(s) - see {@link *    Query::get}.
     * @param  array  $where  Where condition for what to select - see {@link *    Query::where}.
     * @param  array  $orderBy  Order condition - see {@link *    Query::order}.
     * @return Result
     */
