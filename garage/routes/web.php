...
Route::get('setting/mobile_setting/list', 'MobileSettingController@index')->name('mobile_setting');
Route::post('setting/mobile_setting/list', 'MobileSettingController@store')->name('mobile_setting');
...
Route::group(['prefix' => 'report'], function () {
    ...
    Route::post('/generate_pdf', 'Reportcontroller@generate_pdf')->middleware('can:report_view');
});
...
Route::post('/sales_part/delete', 'SalesPartcontroller@destroyMultiple')->middleware('can:salespart_delete');
