...
class JobCardcontroller extends Controller
{
    ...
    public function addproducts(Request $request)
    {
        ...
        <tr id="<?php echo $rowid; ?>">
            ...
            <td>
                <input type="text" name="other_price[]" class="form-control other_service_price otherPriceCheckVal" id="oth_price" value="<?php if (! empty($pros)) {
                    echo $product->total_price;
                } ?>" maxlength="8">
            </td>

            <td class="text-center">
                <span class="trash_product" style="cursor: pointer;" data-id="<?php echo $ids; ?>"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></span>
            </td>
        </tr>
    <?php
    }
